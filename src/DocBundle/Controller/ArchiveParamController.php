...
class ArchiveParamController extends Controller {
	...
	public function newAction(Request $request) {
		...
		if ($form->isSubmitted () && $form->isValid ()) {
			...
			return $this->redirectToRoute ( 'archiveparam_show', array (
					'id' => $archiveParam->getId () 
			) );
		}
	...
	public function editAction(Request $request, ArchiveParam $archiveParam) {
		...
		if ($editForm->isSubmitted () && $editForm->isValid ()) {
			...
			return $this->redirectToRoute ( 'archiveparam_edit', array (
					'id' => $archiveParam->getId () 
			) );
		}
	...
	private function createDeleteForm(ArchiveParam $archiveParam) {
		return $this->createFormBuilder ()->setAction ( $this->generateUrl ( 'archiveparam_delete', array (
				'id' => $archiveParam->getId () 
